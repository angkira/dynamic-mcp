...
SELECT 
  ...
  'NONE',
  true,
  '{"tools": [{"name": "create_mcp_server", "description": "Create and register a new MCP server instance"}, {"name": "update_mcp_server", "description": "Update configuration of existing MCP server"}, {"name": "delete_mcp_server", "description": "Remove MCP server and cleanup resources"}, {"name": "test_mcp_connection", "description": "Test connectivity and capabilities of MCP server"}, {"name": "list_mcp_servers", "description": "List all registered MCP servers with status"}, {"name": "get_mcp_capabilities", "description": "Retrieve detailed capabilities of MCP server"}], "resources": [{"uri": "mcp://servers", "name": "MCP Server Registry", "description": "Dynamic MCP server management", "mimeType": "application/json"}], "prompts": []}'::jsonb,
  CURRENT_TIMESTAMP
FROM "public"."User" u 
WHERE u.email = 'demo@example.com'
